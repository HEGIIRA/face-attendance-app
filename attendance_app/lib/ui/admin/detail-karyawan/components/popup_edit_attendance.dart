...
import 'package:attendance_app/ui/admin/detail-karyawan/components/edit_attendance_form.dart';
import 'package:attendance_app/ui/const.dart';
import 'package:attendance_app/ui/admin/detail-karyawan/components/edit_form.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

void popupEditAttendance(BuildContext context, EmployeeModel attendanceData) {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // EditAttendanceForm(employee: attendanceData)
                ],
              ),
            )),
      );
